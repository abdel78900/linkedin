...
function HeaderLink({ Icon, text, feed, active, avatar, hidden, rotate }) {
  ...
  return (
    <div
      ...
      } ${active && "!text-black dark:!text-white"} ${rotate && "-rotate-45 -translate-y-2 translate-x-3"}`}
    ...
    >
      ...
      <h4
        ...
        } ${rotate && "rotate-45 -translate-x-6 -translate-y-2"}`}
      >
        {text}
      </h4>
